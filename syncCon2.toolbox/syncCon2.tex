...
\@x{ counter \.{\defeq} 0\@s{8.2}}%
\@y{\@s{0}%
 record the \ensuremath{FailNum
}}%
\@xx{}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} syncCon2 {\p@lbrace}}%
\@x{\@s{16.4} {\p@variables} FailNum \.{=} FAILNUM {\p@semicolon}\@s{41.0}}%
\@y{\@s{0}%
 Initialization block
}%
\@xx{}%
 \@x{\@s{64.16} up \.{=} [ n\@s{4.62} \.{\in} Nodes \.{\mapsto} {\TRUE} ]
 {\p@semicolon}\@s{21.12}}%
\@y{\@s{0}%
 Nodes are up
}%
\@xx{}%
 \@x{\@s{64.16} pt\@s{1.72} \.{=} [ n\@s{4.62} \.{\in} Nodes \.{\mapsto} 0 ]
 {\p@semicolon}\@s{39.55}}%
\@y{\@s{0}%
 Nodes are at round 0
}%
\@xx{}%
 \@x{\@s{64.16} t\@s{1.87} \.{=} [ n \.{\in} Nodes \.{\mapsto} {\FALSE} ]
 {\p@semicolon}\@s{28.25}}%
\@y{\@s{0}%
 Nodes are not terminated
}%
\@xx{}%
 \@x{\@s{64.16} d \.{=} [ n \.{\in} Nodes \.{\mapsto} \.{-} 1 ]
 {\p@semicolon}\@s{36.92}}%
\@y{\@s{0}%
 Nodes are not decided
}%
\@xx{}%
 \@x{\@s{64.16} mb \.{=} [ n \.{\in} Nodes \.{\mapsto} \{ \} ]
 {\p@semicolon}\@s{36.88}}%
\@y{\@s{0}%
...
\@x{\@s{16.4} {\p@define} {\p@lbrace}}%
 \@x{\@s{32.8} SetMin ( S ) \.{\defeq} {\CHOOSE} i \.{\in} S \.{:} \A\, j
 \.{\in} S \.{:} i \.{\leq} j}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@macro} MaybeFail {\p@lparen} {\p@rparen} {\p@lbrace}}%
 \@x{\@s{32.8} {\p@if} {\p@lparen} FailNum \.{>} 0 \.{\land} up [ self ]
 {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
 \@x{\@s{49.19} {\p@either} {\p@lbrace} up [ self ] \.{:=} {\FALSE}
 {\p@semicolon} FailNum \.{:=} FailNum \.{-} 1 {\p@semicolon} counter \.{:=}
 counter \.{+} 1 {\p@rbrace}\@s{8.2}}%
\@y{\@s{0}%
 if fail, \ensuremath{counter \.{=} counter \.{+}1
}}%
\@xx{}%
\@x{\@s{49.19} {\p@or} {\p@skip} {\p@semicolon}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} n \.{\in} Nodes {\p@rparen}}%
\@x{\@s{16.4} {\p@variables} v \.{=} 0 ,\, Q \.{=} \{ \} {\p@semicolon}}%
\@x{\@s{16.4} {\p@lbrace}}%
 \@x{\@s{32.8} P\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} up [ self ]
 {\p@rparen} {\p@lbrace}}%
\@x{\@s{67.62} v\@s{2.93} \.{:=} self {\p@semicolon}}%
\@x{\@s{67.62} Q \.{:=} Nodes {\p@semicolon}}%
 \@x{\@s{46.88} PS\@s{.5}\textrm{:}\@s{3}\@s{0.86} {\p@while} {\p@lparen} pt [
 self ] \.{\leq} counter {\p@rparen} {\p@lbrace}}%
 \@x{\@s{84.02} {\p@if} {\p@lparen} pt [ self ] \.{=} 0 {\p@rparen}
 {\p@lbrace}}%
\@x{\@s{102.87} Q \.{:=} Nodes {\p@semicolon}}%
 \@x{\@s{102.87} L1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} up [ self ]
 \.{\land} Q \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}%
\@x{\@s{120.42} {\p@with} {\p@lparen} p \.{\in} Q {\p@rparen} {\p@lbrace}}%
\@x{\@s{132.72} MaybeFail ( ) {\p@semicolon}\@s{8.2}}%
\@y{\@s{0}%
 the node can crash when sending message
}%
\@xx{}%
 \@x{\@s{132.72} {\p@if} {\p@lparen} {\lnot} up [ self ] {\p@rparen}
 {\p@lbrace}\@s{20.5}}%
\@y{\@s{0}%
 if the node crash, it\mbox{'}s terminated
}%
\@xx{}%
\@x{\@s{151.57} t [ self ] \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{151.57} {\p@goto} PR {\p@semicolon}}%
\@x{\@s{132.72} {\p@rbrace}}%
\@x{\@s{132.72} {\p@else} {\p@lbrace}}%
 \@x{\@s{149.12} mb [ p ] \.{:=} mb [ p ] \.{\cup} \{ v \}
 {\p@semicolon}\@s{12.29}}%
\@y{\@s{0}%
 put value \ensuremath{v} into the node\mbox{'}s mailbox
}%
\@xx{}%
 \@x{\@s{149.12} Q \.{:=} Q \.{\,\backslash\,} \{ p \}
 {\p@semicolon}\@s{47.21}}%
\@y{\@s{0}%
 delete \ensuremath{p} out of the set \ensuremath{Q
}}%
\@xx{}%
\@x{\@s{132.72} {\p@rbrace}}%
\@x{\@s{120.42} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{102.87} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{84.02} {\p@rbrace}}%
\@x{\@s{84.02} {\p@else} {\p@lbrace}}%
 \@x{\@s{106.13} {\p@await} ( \A\, i \.{\in} Nodes \.{:} pt [ i ] \.{\geq} 1
 \.{\lor} {\lnot} up [ i ] ) {\p@semicolon}\@s{8.2}}%
\@y{\@s{0}%
 for all nodes, if not at at round 0, or \ensuremath{up[i] \.{=} Fasle
}}%
\@xx{}%
\@x{\@s{106.13} Q \.{:=} Nodes {\p@semicolon}}%
 \@x{\@s{106.13} L2\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} up [ self ]
 \.{\land} Q \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}%
\@x{\@s{118.43} {\p@with} {\p@lparen} p \.{\in} Q {\p@rparen} {\p@lbrace}}%
\@x{\@s{130.73} MaybeFail ( ) {\p@semicolon}}%
 \@x{\@s{130.73} {\p@if} {\p@lparen} {\lnot} up [ self ] {\p@rparen}
 {\p@lbrace}}%
\@x{\@s{149.58} t [ self ] \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{149.58} {\p@goto} PR {\p@semicolon}}%
\@x{\@s{130.73} {\p@rbrace}}%
\@x{\@s{130.73} {\p@else} {\p@lbrace}}%
\@x{\@s{147.13} mb [ p ] \.{:=} mb [ p ] \.{\cup} mb [ self ] {\p@semicolon}}%
\@x{\@s{147.13} Q \.{:=} Q \.{\,\backslash\,} \{ p \} {\p@semicolon}}%
\@x{\@s{130.73} {\p@rbrace}}%
\@x{\@s{118.43} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{106.13} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{84.02} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{84.02} L3\@s{.5}\textrm{:}\@s{3}\@s{8.16} pt [ self ] \.{:=} pt [
 self ] \.{+} 1 {\p@semicolon}}%
\@x{\@s{67.62} {\p@rbrace} {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{46.88} PR\@s{.5}\textrm{:}\@s{3} {\p@await} ( \A\, n \.{\in} Nodes
 \.{:} ( pt [ n ] \.{=} counter \.{+} 1 \.{\lor} up [ n ] \.{=} {\FALSE} ) )
 {\p@semicolon}\@s{4.1}}%
\@y{\@s{0}%
 await for all nodes at rounds \ensuremath{counter\.{+}1} or
 \ensuremath{up[n] \.{=}} False
}%
\@xx{}%
 \@x{\@s{67.62} {\p@if} {\p@lparen} up [ self ] {\p@rparen} d [ self ] \.{:=}
 SetMin ( mb [ self ] ) {\p@semicolon}}%
\@x{\@s{67.62} t [ self ] \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{\@s{57.56} \.{\land} {\IF} pt [ self ] \.{\leq} counter}%
\@x{\@s{80.82} \.{\THEN} \.{\land} {\IF} pt [ self ] \.{=} 0}%
 \@x{\@s{135.40} \.{\THEN} \.{\land} Q \.{'} \.{=} [ Q {\EXCEPT} {\bang} [
 self ] \.{=} Nodes ]}%
 \@x{\@s{166.71} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{L1} ]}%
 \@x{\@s{135.40} \.{\ELSE} \.{\land} ( \A\, i \.{\in} Nodes \.{:} pt [ i ]
 \.{\geq} 1 \.{\lor} {\lnot} up [ i ] )}%
 \@x{\@s{166.71} \.{\land} Q \.{'} \.{=} [ Q {\EXCEPT} {\bang} [ self ] \.{=}
 Nodes ]}%
 \@x{\@s{166.71} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{L2} ]}%
 ...
 self ] \.{=}\@w{PR} ]}%
\@x{\@s{112.13} \.{\land} Q \.{'} \.{=} Q}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} FailNum ,\, up ,\, pt ,\, t
 ,\, d ,\, mb ,\, v {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L3 ( self )\@s{3.19} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{L3}}%
 \@x{\@s{57.56} \.{\land} pt \.{'}\@s{0.38} \.{=} [ pt {\EXCEPT} {\bang} [
 self ]\@s{0.38} \.{=} pt [ self ] \.{+} 1 ]}%
 \@x{\@s{57.56} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PS} ]}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} FailNum ,\, up ,\, t ,\, d
 ,\, mb ,\, v ,\, Q {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L1 ( self )\@s{3.19} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{L1}}%
...
\@x{\@s{208.24} \.{\land} counter \.{'}\@s{4.83} \.{=} counter \.{+} 1}%
...
\@x{\@s{131.44} \.{\land} {\IF} {\lnot} up \.{'} [ self ]}%
 \@x{\@s{154.71} \.{\THEN} \.{\land} t \.{'} \.{=} [ t {\EXCEPT} {\bang} [
 self ] \.{=} {\TRUE} ]}%
 \@x{\@s{186.02} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PR} ]}%
\@x{\@s{186.02} \.{\land} {\UNCHANGED} {\langle} mb ,\, Q {\rangle}}%
 \@x{\@s{154.71} \.{\ELSE} \.{\land} mb \.{'} \.{=} [ mb {\EXCEPT} {\bang} [ p
 ] \.{=} mb [ p ] \.{\cup} \{ v [ self ] \} ]}%
 \@x{\@s{186.02} \.{\land} Q \.{'} \.{=} [ Q {\EXCEPT} {\bang} [ self ] \.{=}
 Q [ self ] \.{\,\backslash\,} \{ p \} ]}%
 \@x{\@s{186.02} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{L1} ]}%
\@x{\@s{186.02} \.{\land} t \.{'} \.{=} t}%
 \@x{\@s{80.82} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{L3} ]}%
 \@x{\@s{112.13} \.{\land} {\UNCHANGED} {\langle} FailNum ,\, up ,\, t ,\, mb
 ,\, Q {\rangle}}%
\@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} pt ,\, d ,\, v {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L2 ( self )\@s{3.19} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{L2}}%
 \@x{\@s{57.56} \.{\land} {\IF} up [ self ] \.{\land} Q [ self ] \.{\neq} \{
 \}}%
\@x{\@s{80.82} \.{\THEN} \.{\land} \E\, p \.{\in} Q [ self ] \.{:}}%
\@x{\@s{131.44} \.{\land} {\IF} FailNum \.{>} 0 \.{\land} up [ self ]}%
...
\@x{ PR ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{PR}}%
 \@x{\@s{57.56} \.{\land} ( \A\, n \.{\in} Nodes \.{:} ( pt [ n ] \.{=}
 counter \.{+} 1 \.{\lor} up [ n ] \.{=} {\FALSE} ) )}%
\@x{\@s{57.56} \.{\land} {\IF} up [ self ]}%
 \@x{\@s{80.82} \.{\THEN} \.{\land} d \.{'} \.{=} [ d {\EXCEPT} {\bang} [ self
 ] \.{=} SetMin ( mb [ self ] ) ]}%
\@x{\@s{80.82} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{112.13} \.{\land} d \.{'} \.{=} d}%
 \@x{\@s{57.56} \.{\land} t \.{'} \.{=} [ t {\EXCEPT} {\bang} [ self ] \.{=}
 {\TRUE} ]}%
 \@x{\@s{57.56} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 ...
 ,\, v ,\, Q {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ n ( self ) \.{\defeq} P ( self ) \.{\lor} PS ( self ) \.{\lor} L3 ( self
 ) \.{\lor} L1 ( self ) \.{\lor} L2 ( self )}%
\@x{\@s{65.28} \.{\lor}\@s{1.21} PR ( self )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{}\midbar\@xx{}%
 \@x{ Inv \.{\defeq} ( \E\, i \.{\in} Nodes \.{:} {\lnot} t [ i ] ) \.{\lor} (
 \A\, l ,\, m \.{\in} Nodes \.{:} {\lnot} up [ l ] \.{\lor} {\lnot} up [ m ]
 \.{\lor} d [ l ] \.{=} d [ m ] )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 24 15:27:38 \ensuremath{EDT} 2017 by \ensuremath{xinboyu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Oct} 24 15:17:22 \ensuremath{EDT} 2017 by kz-\ensuremath{pc
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Oct} 24
 14:42:35 \ensuremath{EDT} 2017 by kz-\ensuremath{pc
}%
\end{cpar}%
\end{lcom}%
\end{document}
