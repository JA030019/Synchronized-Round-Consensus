...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} syncCon1 {\p@lbrace}}%
...
\@x{\@s{16.4} {\p@define} {\p@lbrace}}%
 ...
 \.{\in} S \.{:} i \.{\leq} j\@s{4.1}}%
\@y{\@s{0}%
 choose the smallest value in \ensuremath{S
}}%
\@xx{}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{49.19} {\p@either}}%
 \@x{\@s{49.19} {\p@lbrace} up [ self ] \.{:=} {\FALSE} {\p@semicolon} FailNum
...
\@x{\@s{16.4} {\p@lbrace}}%
 \@x{\@s{49.19} P\@s{.5}\textrm{:}\@s{3}\@s{2.55} {\p@if} {\p@lparen} up [
 self ] {\p@rparen} {\p@lbrace}}%
\@x{\@s{88.78} v\@s{2.93} \.{:=} self {\p@semicolon}}%
\@x{\@s{88.78} Q \.{:=} Nodes {\p@semicolon}}%
 \@x{\@s{49.19} PS\@s{.5}\textrm{:}\@s{3}\@s{0.86} {\p@while} {\p@lparen} up [
 self ] \.{\land} Q \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}%
\@x{\@s{82.24} {\p@with} {\p@lparen} p \.{\in} Q {\p@rparen} {\p@lbrace}}%
\@x{\@s{120.84} MaybeFail ( ) {\p@semicolon}\@s{24.59}}%
\@y{\@s{0}%
 the node can crash when sending message
}%
\@xx{}%
 \@x{\@s{120.84} mb [ p ] \.{:=} mb [ p ] \.{\cup} \{ v \}
 {\p@semicolon}\@s{20.5}}%
\@y{\@s{0}%
 put value \ensuremath{v} into the node\mbox{'}s mailbox
}%
\@xx{}%
 \@x{\@s{120.84} Q \.{:=}\@s{4.1} Q \.{\,\backslash\,} \{ p \}
 {\p@semicolon}\@s{24.59}}%
\@y{\@s{0}%
 delete \ensuremath{p} out of the set \ensuremath{Q
}}%
\@xx{}%
\@x{\@s{82.24} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{65.84} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{65.84} {\p@if} {\p@lparen} up [ self ] {\p@rparen} pt [ self ] \.{:=}
 pt [ self ] \.{+} 1 {\p@semicolon}}%
 \@x{\@s{45.1} PR\@s{.5}\textrm{:}\@s{3} {\p@await} ( up [ self ] ) \.{\land}
 ( \A\, i \.{\in} Nodes \.{:} ( pt [ i ] \.{=} 1 \.{\lor} up [ i ] \.{=}
 {\FALSE} ) ) {\p@semicolon}}%
\@y{\@s{0}%
 wait for all nodes receive others\mbox{'} message
}%
\@xx{}%
 \@x{\@s{65.84} d [ self ] \.{:=} SetMin ( mb [ self ] )
 {\p@semicolon}\@s{8.2}}%
\@y{\@s{0}%
 use \ensuremath{SetMin()} function to decide the smallest value in collection
}%
\@xx{}%
\@x{\@s{65.84} t [ self ]\@s{1.87} \.{:=} {\TRUE} {\p@semicolon}\@s{61.5}}%
\@y{\@s{0}%
 when the node has decide the smallest value, it\mbox{'}s done.
}%
\@xx{}%
\@pvspace{8.0pt}%
...
\ensuremath{\.{\,\backslash\,}}* 1.2 Model-check safety properties with TLA+
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* First, we assume no crash. It means after
 this round, every node sends it value to others and decide the smallest
 value.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* So at the model check, we set
 \ensuremath{FailNum \.{=} 0}, \ensuremath{Nodes \.{=} 5}, choose the
 termination property and there is no error.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Then change the \ensuremath{FailNum} to
 1,2,3,4, Node still equals 5, choose the termination property, then error
 happens.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* For examle, \ensuremath{node1} crash when
 only \ensuremath{node2} receive it\mbox{'}s value. Assume others node
 don\mbox{'}t crash and program still run,
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Then \ensuremath{node2} set the min value
 \ensuremath{\.{=} 1}, but
 \ensuremath{node3},\ensuremath{node4},\ensuremath{node5} can not set min
 value \ensuremath{\.{=} 1}. So this consensus protocol algorithm
 does\mbox{'}t work.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* And at this algorithm, when
 \ensuremath{node1} crash, \ensuremath{up[1]} will be False. So the
 termination property will be violated.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* So the agreement property satisfied when
 \ensuremath{FailNum \.{=} 0}, unsatisfied when \ensuremath{FailNum \.{>} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Then test an invariant property
 \ensuremath{Inv \.{\defeq}} (\ensuremath{\E\, i \.{\in} Nodes} :
 \ensuremath{{\lnot}t[i]}) \ensuremath{\.{\lor}} (\ensuremath{\A\,
 l},\ensuremath{m \.{\in} Nodes} : \ensuremath{{\lnot}up[l] \.{\lor}
 {\lnot}up[m] \.{\lor} d[l] \.{=} d[m]})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* An invariant property should be satisfied at
 every situations. So check the invariant property when \ensuremath{FailNum}
 from 0 to 4. It maintains right.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 24 15:24:46 \ensuremath{EDT} 2017 by \ensuremath{xinboyu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Oct} 24 11:58:03 \ensuremath{EDT} 2017 by kz-\ensuremath{pc
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Oct} 21 11:02:18
 \ensuremath{EDT} 2017 by kz-\ensuremath{pc
}%
\end{cpar}%
\end{lcom}%
\end{document}
